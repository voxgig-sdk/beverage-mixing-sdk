...
describe("DareEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BEVERAGE_MIXING_TEST_DARE_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    assert.is_not_nil(dare_ref01_data_dt0_loaded)
...
function dare_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BEVERAGE_MIXING_TEST_DARE_ENTID")
