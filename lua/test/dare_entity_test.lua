...
describe("DareEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BEVERAGEMIXING_TEST_DARE_ENTID JSON to run live")
      return
    end
...
function dare_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BEVERAGEMIXING_TEST_DARE_ENTID")
