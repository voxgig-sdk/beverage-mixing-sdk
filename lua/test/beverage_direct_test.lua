...
describe("BeverageDirect", function()
  it("should direct-load-beverage", function()
    local setup = beverage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-beverage", setup.live and "live" or "unit")
