...
describe("DareDirect", function()
  it("should direct-load-dare", function()
    local setup = dare_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dare", setup.live and "live" or "unit")
