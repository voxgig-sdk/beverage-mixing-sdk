...
function runner.env_override(m)
  local live = runner.getenv("BEVERAGEMIXING_TEST_LIVE")
  local override = runner.getenv("BEVERAGEMIXING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BEVERAGEMIXING_TEST_EXPLAIN")
