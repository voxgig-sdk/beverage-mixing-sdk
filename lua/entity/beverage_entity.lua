...
local BeverageEntity = {}
BeverageEntity.__index = BeverageEntity


function BeverageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BeverageEntity)
  self._name = "beverage"
  self._client = client
...
function BeverageEntity:get_name()
  return self._name
end


function BeverageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BeverageEntity.new(self._client, opts)
end
...
function BeverageEntity:mark_deleted()
  self._deleted = true
end


function BeverageEntity:deleted()
  return true == self._deleted
end


function BeverageEntity:data_set(args)
  if args ~= nil then
...
function BeverageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BeverageEntity:match_set(args)
  if args ~= nil then
...
function BeverageEntity:match_get()
...
function BeverageEntity:stream(action, args, callopts)
...
---@param reqmatch BeverageLoadMatch
---@param ctrl? table
---@return Beverage
---@return string? err
function BeverageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BeverageEntity:_run_op(ctx, post_done)
  local utility = self._utility
