...
class DareEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BEVERAGEMIXING_TEST_DARE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def dare_basic_setup(extra)
  ...
  entid_env_raw = ENV["BEVERAGEMIXING_TEST_DARE_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["BEVERAGEMIXING_TEST_DARE_ENTID"])
