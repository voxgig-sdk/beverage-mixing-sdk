...
class DareEntity
  ...
  # @return [Dare, Hash] the current Dare data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dare fields)
  def match_get
  ...
  # Load a single Dare.
  #
  # @param reqmatch [DareLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Dare.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Dare, Hash] the loaded Dare; raises BeverageMixingError on failure
