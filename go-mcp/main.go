// Command BeverageMixing-mcp is an MCP server exposing the BeverageMixing
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BeverageMixing_list  — list records of an entity
//	BeverageMixing_load  — load a single record of an entity
//
