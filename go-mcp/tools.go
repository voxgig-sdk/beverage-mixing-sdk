...
type Args struct {
	Entity string         `json:"entity" jsonschema:"beverage | dare"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BeverageMixingSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "beverage-mixing_list",
		Description: "List records from BeverageMixing. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "beverage-mixing_load",
		Description: "Load a single record from BeverageMixing. " +
...
func runOp(client *sdk.BeverageMixingSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BeverageMixingSDK, name string) (sdk.BeverageMixingEntity, error) {
	switch strings.ToLower(name) {
	case "beverage":
		return client.Beverage(nil), nil
	case "dare":
		return client.Dare(nil), nil
