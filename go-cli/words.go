...
func registerSDKWords(r *eng.Registry, client *sdk.BeverageMixingSDK) {
...
func runOp(client *sdk.BeverageMixingSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
