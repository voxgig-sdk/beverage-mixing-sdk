...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/beverage-mixing` | `npm install @voxgig-sdk/beverage-mixing` |
| Python | `voxgig-sdk-beverage-mixing` | `pip install voxgig-sdk-beverage-mixing` |
| PHP | `voxgig-sdk/beverage-mixing` | `composer require voxgig-sdk/beverage-mixing` |
| Golang | `github.com/voxgig-sdk/beverage-mixing-sdk/go` | `go get github.com/voxgig-sdk/beverage-mixing-sdk/go` |
| Ruby | `voxgig-sdk-beverage-mixing` | `gem install voxgig-sdk-beverage-mixing` |
| Lua | `voxgig-sdk-beverage-mixing` | `luarocks install voxgig-sdk-beverage-mixing` |
