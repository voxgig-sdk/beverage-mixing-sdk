...
class BeverageMixingTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BeverageMixingTestRunner.getenv("BEVERAGEMIXING_TEST_LIVE")
        override = BeverageMixingTestRunner.getenv("BEVERAGEMIXING_TEST_OVERRIDE")
        ...
        explain = BeverageMixingTestRunner.getenv("BEVERAGEMIXING_TEST_EXPLAIN")
