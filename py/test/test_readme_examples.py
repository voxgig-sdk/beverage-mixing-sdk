# BeverageMixing SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BeverageMixingSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BeverageMixingSDK(...) and BeverageMixingSDK.test(...) become
#      BeverageMixingSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "beveragemixing_sdk"
_SDK_CLASS = "BeverageMixingSDK"
