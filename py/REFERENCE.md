# BeverageMixing Python SDK Reference

Complete API reference for the BeverageMixing Python SDK.
...
#### `BeverageMixingSDK.test(testopts=None, sdkopts=None)`
...
Create a new `BeverageEntity` instance. Pass `None` for no initial data.
...
Create a new `BeverageEntity` instance with the same options.
...
| `creator` | `str` | Yes | API creator name |
| `result` | `str` | Yes | The dare challenge text |
