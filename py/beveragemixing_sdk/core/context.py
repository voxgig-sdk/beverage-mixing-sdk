...
from beveragemixing_sdk.core.helpers import get_ctx_prop, to_map
...
class BeverageMixingContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BeverageMixingControl()
        ...
        if isinstance(sp, BeverageMixingSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BeverageMixingResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BeverageMixingResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BeverageMixingOperation({})
    ...
    def make_error(self, code, msg):
        return BeverageMixingError(code, msg, self)
