...
from beveragemixing_sdk.utility import register

# Load features
from beveragemixing_sdk.feature.base_feature import BeverageMixingBaseFeature
from beveragemixing_sdk.features import _has_feature, _make_feature
...
class BeverageMixingSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BeverageMixingUtility()
        self._utility = utility

        from beveragemixing_sdk.config import shared_config
    ...
    def get_utility(self):
        return BeverageMixingUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BeverageMixingSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Beverage(self, data=None) -> "BeverageEntity":
        ...
        from beveragemixing_sdk.entity.beverage_entity import BeverageEntity
        return BeverageEntity(self, data)


    def Dare(self, data=None) -> "DareEntity":
        """Entity factory: client.Dare().list() / client.Dare().load({"id": ...})."""
        from beveragemixing_sdk.entity.dare_entity import DareEntity
