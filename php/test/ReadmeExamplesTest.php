...
// BeverageMixing SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BeverageMixingSDK::test)
...
{
    private const SDK_CLASS = 'BeverageMixingSDK';
    ...
    private const SDK_BASE = 'beveragemixing_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../beveragemixing_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
