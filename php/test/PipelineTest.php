...
// BeverageMixing SDK pipeline test
//
...
{
    private static function utility(): BeverageMixingUtility
    {
        return new BeverageMixingUtility();
    }
    ...
    private static function ctx(array $over = []): BeverageMixingContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BeverageMixingContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BeverageMixingOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BeverageMixingError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BeverageMixingOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BeverageMixingMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BeverageMixingOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BeverageMixingMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BeverageMixingOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BeverageMixingMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BeverageMixingSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BeverageMixingMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BeverageMixingResponse([]),
            'result' => new BeverageMixingResult([]),
        ]);
        [, $err] = BeverageMixingMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec([]),
            'response' => null,
            'result' => new BeverageMixingResult([]),
        ]);
        [, $err] = BeverageMixingMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec(['step' => 's']),
            'response' => new BeverageMixingResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BeverageMixingResult([]),
        ]);
        [, $err] = BeverageMixingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec(['step' => 's']),
            'response' => new BeverageMixingResponse(self::resp(200, ['v' => 1])),
            'result' => new BeverageMixingResult([]),
        ]);
        [, $err] = BeverageMixingMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec(['step' => 's']),
            'response' => new BeverageMixingResponse(self::resp(200, ['v' => 2])),
            'result' => new BeverageMixingResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BeverageMixingMakeResponse::call($ctx);
    ...
    {
        $preset = new BeverageMixingResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec([]),
            'response' => new BeverageMixingResponse([]),
            'result' => new BeverageMixingResult([]),
        ...
        [$got, $err] = BeverageMixingMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BeverageMixingResult([])]);
        [, $err] = BeverageMixingMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BeverageMixingSpec([]), 'result' => null]);
        [, $err] = BeverageMixingMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BeverageMixingSpec(['step' => 's']),
            'result' => new BeverageMixingResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BeverageMixingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BeverageMixingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BeverageMixingSpec(['step' => 's']),
            'result' => new BeverageMixingResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BeverageMixingOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BeverageMixingMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BeverageMixingResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BeverageMixingSpec([]),
            'result' => new BeverageMixingResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BeverageMixingMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BeverageMixingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BeverageMixingError('boom', 'boom');
        $utility->fetcher = function (BeverageMixingContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BeverageMixingSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BeverageMixingMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BeverageMixingContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BeverageMixingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BeverageMixingResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BeverageMixingMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BeverageMixingContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BeverageMixingSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BeverageMixingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BeverageMixingResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BeverageMixingSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BeverageMixingMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BeverageMixingMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BeverageMixingMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BeverageMixingResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BeverageMixingDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BeverageMixingResult(['ok' => false])]);
        $this->expectException(BeverageMixingError::class);
        BeverageMixingDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BeverageMixingResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BeverageMixingMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BeverageMixingMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BeverageMixingBaseFeature();
        $b = new BeverageMixingBaseFeature();
        BeverageMixingFeatureAdd::call($ctx, $a);
        BeverageMixingFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BeverageMixingBaseFeature
    {
        $f = new BeverageMixingBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BeverageMixingFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BeverageMixingContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BeverageMixingSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BeverageMixingPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BeverageMixingPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BeverageMixingResponse(['headers' => null]),
            'result' => new BeverageMixingResult([]),
        ]);
        BeverageMixingResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BeverageMixingResultBody::call($ctx);
