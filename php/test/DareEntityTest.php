...
class DareEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BEVERAGE_MIXING_TEST_DARE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $this->assertNotNull($dare_ref01_data_dt0_loaded);
...
function dare_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BEVERAGE_MIXING_TEST_DARE_ENTID");
