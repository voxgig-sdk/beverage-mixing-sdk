...
// BeverageMixing SDK cache feature
...
class BeverageMixingCacheFeature extends BeverageMixingBaseFeature
{
    ...
    private function _through(BeverageMixingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
