...
// BeverageMixing SDK timeout feature
...
class BeverageMixingTimeoutFeature extends BeverageMixingBaseFeature
{
    ...
    private function _with_timeout(BeverageMixingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BeverageMixingContext $_ctx, float $ms): void
    {
        $client = $this->client;
