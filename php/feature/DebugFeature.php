...
// BeverageMixing SDK debug feature
...
class BeverageMixingDebugFeature extends BeverageMixingBaseFeature
{
    ...
    private function _finish(BeverageMixingContext $ctx, bool $ok): void
    {
