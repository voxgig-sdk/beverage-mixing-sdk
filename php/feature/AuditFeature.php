...
// BeverageMixing SDK audit feature
...
class BeverageMixingAuditFeature extends BeverageMixingBaseFeature
{
    ...
    private function _emit(BeverageMixingContext $ctx, string $outcome): void
    {
