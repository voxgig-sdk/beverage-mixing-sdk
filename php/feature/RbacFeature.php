...
// BeverageMixing SDK rbac feature
...
class BeverageMixingRbacFeature extends BeverageMixingBaseFeature
{
    ...
    private function _required(BeverageMixingContext $ctx): ?string
    {
    ...
    private function _reject(BeverageMixingContext $ctx, string $required): void
    {
    ...
    private function _track(BeverageMixingContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
