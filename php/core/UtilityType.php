...
// BeverageMixing SDK utility type

class BeverageMixingUtility
{
    ...
    public static function copy(BeverageMixingUtility $src): BeverageMixingUtility
    {
        $u = new BeverageMixingUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
