...
// BeverageMixing SDK utility: graphql
//
...
class BeverageMixingGraphql
{
    ...
    // equivalent.
    public static function body(BeverageMixingContext $ctx): mixed
    {
    ...
    public static function errors(BeverageMixingContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
