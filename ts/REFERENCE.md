# BeverageMixing TypeScript SDK Reference

Complete API reference for the BeverageMixing TypeScript SDK.
...
```ts
new BeverageMixingSDK(options?: object)
```
...
#### `BeverageMixingSDK.test(testopts?, sdkopts?)`
...
**Returns:** `BeverageMixingSDK` instance in test mode.


### Instance Methods

#### `Beverage(data?: object)`

Create a new `Beverage` entity instance.
...
**Returns:** `BeverageEntity` instance.
...
Alias for `BeverageMixingSDK.test()`.
...
Return the parent `BeverageMixingSDK` instance.
