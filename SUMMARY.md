...
Results: Successful response with beverage mixing recommendation.
...
Results: Successful response with dare challenge.
...
| --- | --- | --- | --- |
| Beverage | `load` | `GET /api/beverage/mix` | See reference |
| Dare | `load` | `GET /api/game/dare` | See reference |

## Connect to the API

- Production server: `https://abhi-api.vercel.app`
...
- `beverage-mixing_list`: List records for an entity. No active entity supports this operation.
- `beverage-mixing_load`: Load one record for an entity. Supported entities: `beverage`, `dare`.
