...
|---|---|---|
| `ts/` | @voxgig-sdk/beverage-mixing-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/beverage-mixing-sdk \
      --repository voxgig-sdk/beverage-mixing-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/beverage-mixing-sdk` shows it, and
`npm trust revoke @voxgig-sdk/beverage-mixing-sdk --id=<id>` removes it.
