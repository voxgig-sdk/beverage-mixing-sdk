...
// BeverageMixing SDK netsim feature
...
class BeverageMixingNetsimFeature extends BeverageMixingBaseFeature
{
    ...
    private function _simulate(BeverageMixingContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BeverageMixingContext $ctx, array $applied): void
    {
        $client = $this->client;
