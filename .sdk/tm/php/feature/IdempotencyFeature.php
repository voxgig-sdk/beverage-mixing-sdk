...
// BeverageMixing SDK idempotency feature
...
class BeverageMixingIdempotencyFeature extends BeverageMixingBaseFeature
{
    ...
    private function _mutating(BeverageMixingContext $ctx): bool
    {
