...
// BeverageMixing SDK proxy feature
...
class BeverageMixingProxyFeature extends BeverageMixingBaseFeature
{
    ...
    public function init(BeverageMixingContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BeverageMixingContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
