...
// BeverageMixing SDK telemetry feature
...
class BeverageMixingTelemetryFeature extends BeverageMixingBaseFeature
{
    ...
    private function _close(BeverageMixingContext $ctx, bool $ok): void
    {
