...
// BeverageMixing SDK streaming feature
...
class BeverageMixingStreamingFeature extends BeverageMixingBaseFeature
{
    ...
    private function _iterate(BeverageMixingResult $result): \Generator
    {
    ...
    private function _streamable(BeverageMixingContext $ctx): bool
    {
