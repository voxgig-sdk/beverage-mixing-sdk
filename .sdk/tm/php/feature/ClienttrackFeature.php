...
// BeverageMixing SDK clienttrack feature
...
class BeverageMixingClienttrackFeature extends BeverageMixingBaseFeature
{
    ...
    public function PostConstruct(BeverageMixingContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BeverageMixing-SDK';
