...
// BeverageMixing SDK ratelimit feature
...
class BeverageMixingRatelimitFeature extends BeverageMixingBaseFeature
{
    ...
    private function _acquire(BeverageMixingContext $ctx): void
    {
    ...
    private function _track(BeverageMixingContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
