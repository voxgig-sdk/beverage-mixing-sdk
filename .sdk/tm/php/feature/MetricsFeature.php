...
// BeverageMixing SDK metrics feature
...
class BeverageMixingMetricsFeature extends BeverageMixingBaseFeature
{
    ...
    private function _record(BeverageMixingContext $ctx, bool $ok): void
    {
