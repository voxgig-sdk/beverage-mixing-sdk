...
// BeverageMixing SDK utility: fetcher

class BeverageMixingFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BeverageMixingSDK/1.0)';
    ...
    public static function call(BeverageMixingContext $ctx, string $fullurl, array $fetchdef): array
    {
