...
// BeverageMixing SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BeverageMixingTransformResponse
{
    public static function call(BeverageMixingContext $ctx): mixed
    {
        ...
        $transform = BeverageMixingHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
