...
// BeverageMixing SDK utility: make_options

class BeverageMixingMakeOptions
{
    ...
    public static function call(BeverageMixingContext $ctx): array
    {
        ...
        //
        // `BeverageMixingSchema::optspec()` is built from the model:
        ...
        $optspec = BeverageMixingSchema::optspec();
