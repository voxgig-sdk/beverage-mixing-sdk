...
func (sdk *BeverageMixingSDK) OptionsMap() map[string]any {
...
func (sdk *BeverageMixingSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BeverageMixingSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BeverageMixingSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BeverageMixingSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BeverageMixingSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BeverageMixingSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BeverageMixingSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BeverageMixingSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BeverageMixingSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BeverageMixingSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BeverageMixingSDK {
	...
	sdk := NewBeverageMixingSDK(sdkopts)
	sdk.Mode = "test"
