...
const testSeed = `map[string]any{"entity": map[string]any{"beverage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dare": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
