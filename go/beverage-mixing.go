...
// instead of `sdk.NewBeverageMixingSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *BeverageMixingSDK  { return NewBeverageMixingSDK(nil) }
func Test() *BeverageMixingSDK { return TestSDK(nil, nil) }
