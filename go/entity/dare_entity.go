...
func NewDareEntity(client *core.BeverageMixingSDK, entopts map[string]any) *DareEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DareEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
