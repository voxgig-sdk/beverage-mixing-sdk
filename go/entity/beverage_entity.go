...
type BeverageEntity struct {
	name    string
	client  *core.BeverageMixingSDK
...
func NewBeverageEntity(client *core.BeverageMixingSDK, entopts map[string]any) *BeverageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BeverageEntity) GetName() string { return e.name }
...
func (e *BeverageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BeverageEntity) Deleted() bool {
	return e.deleted
}


func (e *BeverageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBeverageEntity(e.client, opts)
}

func (e *BeverageEntity) Data(args ...any) any {
...
func (e *BeverageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Beverage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BeverageEntity) DataTyped(data ...Beverage) Beverage {
	if len(data) > 0 {
		return typedFrom[Beverage](e.Data(asMap(data[0])))
	}
	return typedFrom[Beverage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Beverage (all fields
// optional at the wire level).
func (e *BeverageEntity) MatchTyped(match ...Beverage) Beverage {
	if len(match) > 0 {
		return typedFrom[Beverage](e.Match(asMap(match[0])))
	}
	return typedFrom[Beverage](e.Match())
}
...
func (e *BeverageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BeverageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BeverageLoadMatch and returns an Beverage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BeverageEntity) LoadTyped(reqmatch BeverageLoadMatch, ctrl map[string]any) (Beverage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Beverage{}, err
	}
	return typedFrom[Beverage](res), nil
}



func (e *BeverageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BeverageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BeverageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BeverageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BeverageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
